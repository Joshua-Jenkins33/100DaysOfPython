...
- [Use scikit-learn to Run Your Own Regression](#use-scikit-learn-to-run-your-own-regression)
  - [Import scikit-learn](#import-scikit-learn)
...
![Regression Line Structure](https://img-b.udemycdn.com/redactor/raw/2020-10-16_15-19-24-b9cd86771c12cda554da251a16471df9.png)
...
![Intercepts and Slopes](https://img-b.udemycdn.com/redactor/raw/2020-10-16_15-31-02-3bdbeb669ce3d7ecebe72abb986e8d35.png)
...
![scikit learn](https://img-b.udemycdn.com/redactor/raw/2020-10-16_15-32-56-3a64b2f8f6ba4fb460c26d3d4573bbb8.png)

## Import scikit-learn
Let's add the `LinearRegression` from scikit-learn to our notebook.

![Imports](https://img-b.udemycdn.com/redactor/raw/2020-10-16_15-35-31-9dd5b42978718c28394b328f636862ae.png)
...
![Budget Explosion](https://img-b.udemycdn.com/redactor/raw/2020-10-16_16-23-44-7a1c656b072897f661cc8efdfca94144.png)
...
**Intercept**: $22,821,538.64 for $0 budget
**Slope**: $1.65 of revenue for every dollar spent
**R-Squared**: 2.94%
...
![Results](https://img-b.udemycdn.com/redactor/raw/2020-10-16_16-40-08-a2334fe9480545050face2f72c4a31cd.png)

This makes sense considering how poorly our data points aligned with our line earlier. 

![Proof At How Bad](https://img-b.udemycdn.com/redactor/raw/2020-10-16_16-43-08-86be88ceaa656f3a0c07f04d3cf0dac7.png)
...
print(f'For new films we estimate a revenue of ${get_y(x, m1, b1)} for a $350 million budget.') # $1,084,257,803.99
print(f'For old films we estimate a revenue of ${get_y(x, m2, b2)} for a $350 million budget.') # $599,521,137.64
```
