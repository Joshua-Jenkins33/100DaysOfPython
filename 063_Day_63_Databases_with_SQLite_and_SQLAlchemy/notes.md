...
- [Day 63: Advanced - Databases with SQLite and SQLAlchemy](#day-63-advanced---databases-with-sqlite-and-sqlalchemy)
  - [Day 63: Creating a Virtual Bookshelf](#day-63-creating-a-virtual-bookshelf)
  - [Download the Starting Project](#download-the-starting-project)
  - [Make the Website Work](#make-the-website-work)
    - [CHALLENGE 1](#challenge-1)
    - [CHALLENGE 2](#challenge-2)
    - [CHALLENGE 3](#challenge-3)
    - [Challenge 4](#challenge-4)
    - [Challenge 5](#challenge-5)
  - [What Happens When You Refresh the Server?](#what-happens-when-you-refresh-the-server)
  - [SQLite Databases](#sqlite-databases)
    - [Creating Tables in our Database](#creating-tables-in-our-database)
  ...
  - [CRUD Operations with SQLAlchemy](#crud-operations-with-sqlalchemy)
    ...
    - [Read a Particular Record by Query](#read-a-particular-record-by-query)
    - [Update a Particular Record by Query](#update-a-particular-record-by-query)
    - [Update a Record by Primary Key](#update-a-record-by-primary-key)
    - [Delete a Particular Record by Primary Key](#delete-a-particular-record-by-primary-key)
  - [Build a SQLite Database into the Flask Website](#build-a-sqlite-database-into-the-flask-website)
